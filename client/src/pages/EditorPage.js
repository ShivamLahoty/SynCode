    ...
    <div className="h-screen bg-zinc-950 flex overflow-hidden">
      ...
      <main className="flex-1 flex flex-col bg-zinc-950 overflow-hidden relative">
        ...
        <div className="flex-1 relative overflow-hidden">
          {/* CODE-EDITOR pane */}
          <div
            className={`absolute top-0 left-0 h-full transition-all duration-300 ease-out bg-zinc-950
              ${showOutput ? 'right-[400px]' : 'right-0'}
            `}
          >
            <Editor
              socketRef={socketRef}
          ...
          {/* OUTPUT drawer */}
          <div
            className={`absolute top-0 right-0 h-full w-[400px] bg-zinc-900 border-l border-zinc-800 flex flex-col
