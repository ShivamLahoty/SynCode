  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <a
        ...
        className="absolute top-6 right-6 p-2.5 rounded-xl bg-zinc-900/80 backdrop-blur-sm
                   border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800
                   transition-all duration-200 group"
        aria-label="View on GitHub"
      >
        <svg
          className="w-5 h-5 text-zinc-400 group-hover:text-zinc-100 transition-colors duration-200"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          <div className="h-14 w-14 mx-auto mb-6 bg-gradient-to-br from-indigo-500 to-purple-600 
